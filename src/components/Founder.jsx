...
export default function Founder() {
  ...
  const t = {
    es: {
      ...
      name: "Stefano Abate",
      role: "CEO & Fundador",
      lead: "“Construyo software como se construye una pieza de maestría: con intención en cada detalle.”",
      p1: "Ingeniero de Sistemas y desarrollador full-stack con 3 años de experiencia. En 2025 fundé SAAE para llevar a las organizaciones plataformas web que de verdad modernizan su forma de trabajar — no plantillas, sino sistemas a medida.",
      p2: "Del boceto al lanzamiento, acompaño cada proyecto de principio a fin: diseño, desarrollo y puesta en producción, con código limpio y componentes reutilizables que reducen la deuda técnica.",
    ...
    en: {
      ...
      name: "Stefano Abate",
      role: "CEO & Founder",
      lead: "“I build software the way you build a piece of mastery: with intent in every detail.”",
      p1: "Systems Engineer and full-stack developer with 3 years of experience. In 2025 I founded SAAE to bring organizations web platforms that truly modernize how they work — not templates, but tailor-made systems.",
      p2: "From sketch to launch, I guide every project end to end: design, development and production, with clean code and reusable components that cut technical debt.",
