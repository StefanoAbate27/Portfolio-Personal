...
const content = {
  es: {
    ...
    title: "El Estudio",
    intro: "SAAE es un estudio de desarrollo web fundado en 2025. Diseñamos y construimos plataformas a medida — no plantillas — que modernizan la manera en que tu organización trabaja, uniendo artesanía y tecnología en cada proyecto.",
    philosophy: "El buen software se nota cuando no se nota.",
    valuesLabel: "Nuestros valores",
    values: [
      ["Maestría", "Código limpio y detalle en cada línea."],
      ["Claridad", "Interfaces simples que la gente entiende."],
      ["Velocidad", "Del boceto al lanzamiento sin demoras."],
    ],
    services: [
      ["Desarrollo Web", "Plataformas y aplicaciones a medida con React, Node y bases de datos robustas."],
      ["Producto & UX", "Interfaces claras, accesibles y centradas en resultados de negocio."],
      ["Sistemas internos", "Paneles, reportes y automatización que modernizan tu operación."],
      ["Del boceto al lanzamiento", "Entrega en ≤4 semanas con componentes reutilizables y menos deuda técnica."],
    ],
  ...
  en: {
    eyebrow: "About Us",
    title: "The Studio",
    intro: "SAAE is a web development studio founded in 2025. We design and build tailor-made platforms — not templates — that modernize how your organization works, uniting craftsmanship and technology in every project.",
    philosophy: "Good software is noticed when it goes unnoticed.",
    valuesLabel: "Our values",
    values: [
      ["Mastery", "Clean code and detail in every line."],
      ["Clarity", "Simple interfaces people understand."],
      ["Speed", "From sketch to launch, no delays."],
    ],
    services: [
      ["Web Development", "Tailor-made platforms and apps with React, Node and robust databases."],
      ["Product & UX", "Clear, accessible interfaces focused on business results."],
      ["Internal systems", "Dashboards, reports and automation that modernize your operation."],
      ["Sketch to launch", "Delivered in ≤4 weeks with reusable components and less technical debt."],
    ],
