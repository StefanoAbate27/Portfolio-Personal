...
export default function Hero() {
  ...
  const t = {
    es: {
      ...
      desc: "Diseñamos y desarrollamos plataformas web que modernizan la manera en que tu organización trabaja.",
    ...
    en: {
      ...
      desc: "We design and develop web platforms that modernize the way your organization works.",
