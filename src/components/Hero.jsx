...
export default function Hero() {
  ...
  const t = {
    es: {
      ...
      h1a: "Software que domina.",
      h1b: "Ingeniería que respalda.",
    ...
    en: {
      ...
      h1a: "Software that dominates.",
      h1b: "Engineering that backs you.",
    ...
    <div className="relative flex min-h-[100svh] flex-col items-center justify-center overflow-hidden px-6 pt-28 pb-12 text-center md:pt-32">
      ...
      <h1 className="display-hero title-depth mx-auto max-w-5xl text-ink">
        <span className="block overflow-hidden">
          <motion.span className="block text-[10.5vw] leading-[1.02] md:text-[6vw]"
            initial={{ y: "110%" }} animate={{ y: "0%" }} transition={{ duration: 0.9, ease, delay: 0.15 }}>
            {t.h1a}
          </motion.span>
        </span>
        <span className="block overflow-hidden">
          <motion.span className="block text-[10.5vw] leading-[1.05] text-ink/85 md:text-[6vw]"
