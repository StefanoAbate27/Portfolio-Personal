...
const content = {
  es: {
    ...
    desc: "No vendemos plantillas ni promesas vacías. Construimos software a medida que impulsa tu negocio — con trato directo, precio claro y resultados que se notan.",
    cta: "Empezar ahora",
    reasons: [
      [Zap, "Entrega ágil", "Del boceto al lanzamiento, con avances visibles cada semana."],
      [Layers, "100% a medida", "Nada de plantillas: cada sistema se construye para tu operación."],
      [UserCheck, "Trato directo", "Hablas con el fundador, no con un intermediario."],
      [BadgeCheck, "Precio claro", "Cotización transparente en 24h, sin sorpresas ni costes ocultos."],
    ],
  },
  en: {
    eyebrow: "Why SAAE?",
    ...
    desc: "No templates, no empty promises. We build tailor-made software that drives your business — with direct contact, clear pricing and results you can feel.",
    cta: "Start now",
    reasons: [
      [Zap, "Agile delivery", "From sketch to launch, with visible progress every week."],
      [Layers, "100% bespoke", "No templates: every system is built for your operation."],
      [UserCheck, "Direct contact", "You talk to the founder, not to a middleman."],
      [BadgeCheck, "Clear pricing", "Transparent quote in 24h — no surprises, no hidden costs."],
    ],
  },
};
